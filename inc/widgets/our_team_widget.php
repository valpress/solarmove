 ...
 */
class Solarmove_Our_Team_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct( 'Solarmove_our_team', 'Solarmove - Team Member Widget', $widget_ops );
...
?>
    ...
    <p><label for="<?php echo $this->get_field_id('image_url'); ?>"><?php _e('Profile Image', 'integral'); ?></label><br />
    ...
    <p class="img-prev"><img src="<?php echo $instance['image_url']; ?>" style="max-width: 100%;"></p>
    <p>
...
add_action( 'widgets_init', create_function( '', "register_widget( 'Solarmove_Our_Team_Widget' );" ) );
