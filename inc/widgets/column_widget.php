 ...
 */
class Solarmove_Column_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_image', 'description' => 'Add a column.' );
        parent::__construct( 'Solarmove_column', 'Solarmove - Column Widget', $widget_ops );
...
add_action( 'widgets_init', create_function( '', "register_widget( 'Solarmove_Column_Widget' );" ) );
