...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<?php if ($integral['page-2-0-title']) { ?><h1><?php echo __($integral['page-2-0-title'], 'solarmove'); ?></h1><?php } ?>
			<?php if ($integral['page-2-0-subtitle']) { ?><h2><?php echo __($integral['page-2-0-subtitle'], 'solarmove'); ?></h2><?php } ?>
			<?php if ($integral['page-2-0-tagline']) { ?>
            <div class="lead text-center">
                <p><?php echo str_replace("\n", "<br>", __($integral['page-2-0-tagline'], 'solarmove')); ?></p>
            </div>
            <?php } ?>
