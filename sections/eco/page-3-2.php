    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 heading">
                <?php if ($integral['page-3-2-title']) { ?><h2><?php echo $integral['page-3-2-title']; ?></h2><?php } ?>
                <?php if ($integral['page-3-2-subtitle']) { ?><p><?php echo $integral['page-3-2-subtitle']; ?></p><?php } ?>
            </div>
        </div>
