	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="lead text-center">
                <p><?php echo str_replace("\n", "<br>", __($integral['page-3-0-tagline'], 'solarmove')); ?></p>
            </div>
            <?php } ?>
			<?php if($integral['page-3-0-btn1-toggle']==true && $integral['page-3-0-btn2-toggle']==false) { ?>
            <div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-3-0-btn1-url']; ?>" class="btn btn-lg btn-secondary btn-solarmove"><?php echo __($integral['page-3-0-btn1-text'], 'solarmove'); ?></a>
			</div>
			...
			<div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-3-0-btn2-url']; ?>" class="btn btn-lg btn-primary btn-solarmove"><?php echo __($integral['page-3-0-btn2-text'], 'solarmove'); ?></a>
			</div>
