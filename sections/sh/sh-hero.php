...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<?php if ($integral['sh-hero-title']) { ?><h1><?php echo __($integral['sh-hero-title'], 'solarmove'); ?></h1><?php } ?>
            ...
            <div class="col-md-12 text-center">
                <a href="<?php echo $integral['sh-hero-btn1-url']; ?>" class="btn btn-lg btn-secondary"><?php echo __($integral['sh-hero-btn1-text'], 'solarmove'); ?></a>
			</div>
			...
			<div class="col-md-12 text-center">
                <a href="<?php echo $integral['sh-hero-btn2-url']; ?>" class="btn btn-lg btn-primary"><?php echo __($integral['sh-hero-btn2-text'], 'solarmove'); ?></a>
			</div>
