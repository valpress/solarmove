...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<?php if ($integral['page-1-0-title']) { ?><h1><?php echo $integral['page-1-0-title']; ?></h1><?php } ?>
			<?php if ($integral['page-1-0-subtitle']) { ?><h2><?php echo $integral['page-1-0-subtitle']; ?></h2><?php } ?>
			<?php if ($integral['page-1-0-tagline']) { ?>
            <div class="lead text-center">
                <p><?php echo str_replace("\n", "<br>", $integral['page-1-0-tagline']); ?></p>
            </div>
            <?php } ?>
			<?php if($integral['page-1-0-btn1-toggle']==true && $integral['page-1-0-btn2-toggle']==false) { ?>
            <div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-1-0-btn1-url']; ?>" class="btn btn-lg btn-secondary"><?php echo $integral['page-1-0-btn1-text']; ?></a>
			</div>
			...
			<div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-1-0-btn2-url']; ?>" class="btn btn-lg btn-primary"><?php echo $integral['page-1-0-btn2-text']; ?></a>
			</div>
