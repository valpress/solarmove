	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-1-0-btn1-url']; ?>" class="btn btn-lg btn-secondary"><?php echo __($integral['page-1-0-btn1-text'], 'solarmove'); ?></a>
			</div>
			...
			<div class="col-md-12 text-center">
                <a href="<?php echo $integral['page-1-0-btn2-url']; ?>" class="btn btn-lg btn-primary"><?php echo __($integral['page-1-0-btn2-text'], 'solarmove'); ?></a>
			</div>
