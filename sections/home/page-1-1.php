...
<section id="page-1-1" class="sm_simple_text_layout sm_simple_text_layout_page-1-1 <?php echo $integral['page-1-1-custom-class']; ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if ($integral['page-1-1-title']) { ?><h2><?php echo $integral['page-1-1-title']; ?></h2><?php } ?>
                <?php if ($integral['page-1-1-text']) { ?><p><?php echo $integral['page-1-1-text']; ?></p><?php } ?>
            </div>
            <?php if($integral['page-1-1-btn1-toggle']==true && $integral['page-1-1-btn2-toggle']==false) { ?>
                <div class="col-md-12 text-center">
                <?php if ($integral['page-1-1-btn1-text']) { ?><a href="<?php echo $integral['page-1-1-btn1-url']; ?>" class="btn btn-lg btn-secondary"><?php echo $integral['page-1-1-btn1-text']; ?></a><?php } ?>
                </div>
                ...
                <div class="col-md-12 text-center">
                <?php if ($integral['page-1-1-btn2-text']) { ?><a href="<?php echo $integral['page-1-1-btn2-url']; ?>" class="btn btn-danger btn-lg btn-primary"><?php echo $integral['page-1-1-btn2-text']; ?></a><?php } ?>
                </div>
