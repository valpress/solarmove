    ...
    <div class="container">
        <div class="row">
            ...
            <?php if($integral['page-1-1-btn1-toggle']==true && $integral['page-1-1-btn2-toggle']==false) { ?>
                ...
                <?php if ($integral['page-1-1-btn1-text']) { ?><a href="<?php echo $integral['page-1-1-btn1-url']; ?>" class="btn btn-lg btn-secondary"><?php echo __($integral['page-1-1-btn1-text'], 'solarmove'); ?></a><?php } ?>
                </div>
                ...
                <div class="col-md-12 text-center">
                <?php if ($integral['page-1-1-btn2-text']) { ?><a href="<?php echo $integral['page-1-1-btn2-url']; ?>" class="btn btn-danger btn-lg btn-primary"><?php echo __($integral['page-1-1-btn2-text'], 'solarmove'); ?></a><?php } ?>
                </div>
